...
<ul>   - [DDE Query](http://www.cix.co.uk/~gort/win32.htm#ddequery) is my oldest tool and is a GUI based utility for sending requests and creating advise loops on items. It was written as the main test harness for my [DDE library](http://www.cix.co.uk/~gort/win32.htm#ncl).
